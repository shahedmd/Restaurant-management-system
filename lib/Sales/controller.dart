...
class SalesController extends GetxController {
  ...
  Future<void> addSale(
    ...
    try {
      ...
      final dailyId = DateFormat('yyyy-MM-dd').format(now);
      final monthlyId = DateFormat('yyyy-MM').format(now);

      final dailyRef =
          FirebaseFirestore.instance.collection('dailySales').doc(dailyId);
      final monthlyRef =
          FirebaseFirestore.instance.collection('monthlySales').doc(monthlyId);
      ...
      await dailyRef.set({
        'orders': FieldValue.arrayUnion([saleData]),
  ...
  try {
    ...
    for (var order in dailyOrders) {
      grandTotal += (order["total"] ?? 0).toDouble();
    }
        ...
        build: (context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Text("Grand Total: $grandTotal BDT",
                  style: pw.TextStyle(
              ...
              pw.Table.fromTextArray(
                ...
                columnWidths: {
                  ...
                  1: const pw.FlexColumnWidth(1), // #Orders
