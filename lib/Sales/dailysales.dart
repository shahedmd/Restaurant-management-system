...
class DailySalesPage extends StatelessWidget {
  ...
  Future<void> pickDate(BuildContext context) async {
    ...
    if (picked != null) {
      selectedDate.value = picked; // reactive, no setState needed
    }
  }
          ...
          if (!snap.hasData || !snap.data!.exists) {
            return Scaffold(
              appBar: AppBar(
                ...
                title: Text(
                  "Daily Sales - ${DateFormat('dd MMM yyyy').format(selectedDate.value)}",
              ...
              actions: [
                ...
                Obx(
                  () => IconButton(
                    ...
                    onPressed:
                        salesController.isLoading.value || orders.isEmpty
                            ? null
                            : () async {
