...
class PrintingController extends GetxController {
  Future<void> generateInvoicePDF(
    ...
    Map<String, dynamic> pointsInfo, // <-- NEW PARAM
  ) async {
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    "BDT${(order['total'] ?? 0).toStringAsFixed(2)}",
                    style: pw.TextStyle(fontSize: 10, font: font),
                  ),
                ],
              ),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    "-BDT${(discount - (pointsInfo['pointsUsed'] ?? 0)).toStringAsFixed(2)}",
                    style: pw.TextStyle(fontSize: 10, font: font),
                  ),
                ],
              ),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    "BDT${discountedTotal.toStringAsFixed(2)}",
                    style: pw.TextStyle(
                      fontSize: 12,
                      fontWeight: pw.FontWeight.bold,
                    ),
              ...
              pw.Text(
                "Previous Points: ${pointsInfo['originalPoints']}",
                style: pw.TextStyle(fontSize: 9, font: font),
              ),
              pw.Text(
                "Used: ${pointsInfo['pointsUsed']}",
                style: pw.TextStyle(fontSize: 9, font: font),
              ),
              pw.Text(
                "Earned: ${pointsInfo['pointsEarned']}",
                style: pw.TextStyle(fontSize: 9, font: font),
              ),
              pw.Text(
                "Remaining: ${pointsInfo['pointsRemaining']}",
                style: pw.TextStyle(fontSize: 9, font: font),
              ),
