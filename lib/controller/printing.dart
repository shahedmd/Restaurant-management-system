...
class PrintingController extends GetxController {
 ...
 Future<void> generateInvoicePDF(
  ...
  // Use override if provided (from admin selection), otherwise fallback to order data
  final paymentMethod =
      paymentMethodOverride ?? order['paymentMethod']?.toString() ?? 'N/A';
  final transactionId =
      transactionIdOverride ?? order['transactionId']?.toString() ?? 'N/A';
        ...
        return pw.Column(
          ...
          children: [
                    ...
                    pw.Expanded(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          if (item['selectedVariant'] != null &&
                              item['selectedVariant']['size'] != null)
                            pw.Text("(${item['selectedVariant']['size']})",
                                style: pw.TextStyle(
            ...
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text("Manual Discount:",
                      style: pw.TextStyle(fontSize: 10, font: font)),
                  pw.Text("-BDT${(discount - (pointsInfo['pointsUsed'] ?? 0)).toStringAsFixed(2)}",
                      style: pw.TextStyle(fontSize: 10, font: font)),
                ]),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text("Points Used:",
                      style: pw.TextStyle(fontSize: 10, font: font)),
                  pw.Text("-BDT${(pointsInfo['pointsUsed'] ?? 0)}",
                      style: pw.TextStyle(fontSize: 10, font: font)),
                ]),
            ...
            // ===== POINTS INFO =====
            pw.Text("---- Loyalty Points ----",
                style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)),
            pw.Text("Previous Points: ${pointsInfo['originalPoints']}",
                style: pw.TextStyle(fontSize: 9, font: font)),
            pw.Text("Used: ${pointsInfo['pointsUsed']}",
                style: pw.TextStyle(fontSize: 9, font: font)),
            pw.Text("Earned: ${pointsInfo['pointsEarned']}",
                style: pw.TextStyle(fontSize: 9, font: font)),
            pw.Text("Remaining: ${pointsInfo['pointsRemaining']}",
                style: pw.TextStyle(fontSize: 9, font: font)),
        ...
        return pw.Column(
          ...
          children: [
            ...
            pw.Center(
              child: pw.Column(
                children: [
                  pw.Text("KOT", style: pw.TextStyle(font: boldFont, fontSize: 20)),
                  pw.SizedBox(height: 5),
            ...
            pw.SizedBox(height: 5),
            pw.Text("Date: $date", style: pw.TextStyle(fontSize: 12, font: font)),
            pw.SizedBox(height: 10),
